...
const items = [
  ...
  { name: "P.C. 208 Terrorism (Felony)", val1: null, val2: null, description: "A violent, criminal act committed by a person to further goals stemming from political, religious, social, or environmental influences." },
  { name: "P.C. 209 Involuntary Manslaughter (Felony)", val1: null, val2: null, description: "Acted recklessly and negligently which resulted in the death of another person." },
  { name: "P.C. 210 Voluntary Manslaughter (Felony)", val1: null, val2: null, description: "Acted in the heat of passion caused by being reasonably and strongly provoked which resulted in the death of another person." },
  { name: "P.C. 211 Second Degree Murder (Felony)", val1: null, val2: null, description: "The unlawful killing of another person without prior planning, occurring as a result of reckless or intentional violence where death was a foreseeable consequence." },
  { name: "P.C. 212 First Degree Murder (Felony)", val1: null, val2: null, description: "The intentional and premeditated killing of another person, carried out with malice and a clear, deliberate intent to cause death." },
